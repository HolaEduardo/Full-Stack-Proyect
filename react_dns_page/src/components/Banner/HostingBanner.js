                ...
                <div className="row">
                    <div className="col-lg-6 col-md-7 d-flex align-items-center">
                        <div className="hosting_content">
                            <h2 className="wow fadeInUp" data-wow-delay="0.3s">Somos la Nube de LATAM</h2>
                            <p className="wow fadeInUp" data-wow-delay="0.5s">Gestiona tus servicios digitales con nuestra interfaz de desarrollo amigable y intuitiva.</p>
                            <a href="/#" className="hosting_btn btn_hover wow fadeInUp" data-wow-delay="0.7s">Conoce nuestros Servicios</a>
                        </div>
                    </div>
