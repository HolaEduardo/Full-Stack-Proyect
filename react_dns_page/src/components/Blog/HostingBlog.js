    ...
    return(
        <section className="h_blog_area sec_pad">
            <div className="container">
                <Sectitle Title="Documentación" TitleP="The full monty burke posh excuse my French Richard cheeky bobby spiffing crikey Why gormless, pear shaped.!" sClass="hosting_title text-center"/>
                <div className="row">
