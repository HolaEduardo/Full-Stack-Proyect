        ...
        return(
            <React.Fragment>
                ...
                <section className="case_studies_area sec_pad">
                    <div className="container">
                        <SeoTitle Title="Neustros casos de estudio" TitleP="The full monty burke posh excuse my French Richard cheeky bobby spiffing crikey Why gormless, pear shaped.!"/>
                        <StudySlider/>
                    </div>
                </section>
                ...
                <section className="seo_partner_logo_area sec_pad">
                    <div className="container">
                        <div className="seo_sec_title text-center mb_70">
                            <Fade bottom><h2>Plataforma para emprendedores, creada por ingenieros<br/> y valorada por ejecutivos.</h2></Fade>
                        </div>
                ...
                <section className="seo_call_to_action_area sec_pad">
                    <div className="container">
                        <div className="seo_call_action_text">
                            <h2>Quieres empezar?<br/> Rápido, conveniente y muy facil!</h2>
                            <a href="http://localhost:8000/accounts/register/" className="about_btn">Registrate</a>
                        </div>
                    </div>
                </section>
            </React.Fragment>
